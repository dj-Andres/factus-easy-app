  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 data-guide="page-title" className="text-xl font-semibold tracking-tight text-ink">Transportistas</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <TourButton tourName="transporters" />
        </div>
      </div>
